...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        spinBox->setGeometry(QRect(190, 30, 42, 25));
        ...
        btnBuscar->setGeometry(QRect(180, 40, 80, 24));
